<?php 
	...
	class appartamento{
		...
		function setNomeApp($NomeApp) { $this->NomeApp = $NomeApp; }
		function getNomeApp() { return $this->NomeApp; }
		function setIndirizzo($Indirizzo) { $this->Indirizzo = $Indirizzo; }
		...
		function setZona($Zona) { $this->Zona = $Zona; }
