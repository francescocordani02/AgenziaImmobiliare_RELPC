...
<nav class="navbar navbar-expand-lg  navbar-dark" style="background-color: #171717;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <?php if ($currentpage != "login" && $currentpage != "registrazione" && $currentpage != "information") {
                if (isset($_SESSION["IsAdmin"])) {
                    if($_SESSION["IsAdmin"] == 1){
                        echo '<li class="nav-item"><a class="nav-link" href="view-requests.php">Richieste di affitto</a></li>' . PHP_EOL . '<li class="nav-item"><a class="nav-link" href="view-apartments.php">Appartamenti di affitto</a></li>' . PHP_EOL . '<li class="nav-item"><a class="nav-link" href="view-bookings.php">Storico prenotazioni</a></li>' . PHP_EOL . '<li class="nav-item"><a class="nav-link" href="view-users.php">Elenco utenti</a></li>';
                    ...
                    echo '<li class="nav-item"><a class="nav-link" href="'.$page.'new-request.php">Nuova richiesta</a></li>' . PHP_EOL . '<li class="nav-item"><a class="nav-link" href="'.$page.'view-my-bookings.php">Le mie prenotazioni</a></li><li class="nav-item"><a class="nav-link" href="'.$page2.'contacts.php">Contatti</a></li>';
                    }
                }else{
