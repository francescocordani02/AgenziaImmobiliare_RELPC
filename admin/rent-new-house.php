                ...
                <div class="col-sm m-4">
                    <div class="container" style="border-style:solid; border-width:4px;border-color:#d6ad60;">
                        <div class="row">
                            <div class="col-12">
                                <div class="container">
                                    <form id="login-form" action="complete-rent-house.php" method="post" enctype="multipart/form-data" class="row g-3" style="text-align:center;color:white;padding-bottom:23px;padding-top:5px;">
                                        <div class="col-md-4">
