        ...
        <div class="container-fluid" style="background-color:#171717; padding-top:30px;">
            <div class="row">
                <div class="col-xl-4 mt-4">
                    <div class="container mt-4" style="border-style:solid; max-width:560px; float: left;border-width:4px;border-color:#d6ad60;">
                        <div class="row">
                            <div class="col-12" style="padding-top:20px;text-align:center;">
                                <img src="../img/logo.gif" class="rounded" alt="..." style="height:170px;padding-bottom:30px;">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
